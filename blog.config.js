...
const BLOG = {
 ...
 APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [22, 23], // 夜间模式起至时间，false时关闭根据时间自动切换夜间模式
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || '彩色打印機', // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:

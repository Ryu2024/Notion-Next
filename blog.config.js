...
const BLOG = {
 ...
 randomMinute = Math.floor(Math.random()),
 APPEARANCE_DARK_TIME = process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [randomHour, randomMinute, randomHour, randomMinute + 10],		   
